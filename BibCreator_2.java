...
//The program consists of reading a file with the file name inputed by the user
...
public class BibCreator_2 {
	 ...
	 * also allows the user to input the necessary informations for the files
	...
	public static void main(String[] args) {
		...
		String input = ""; //file name being read by the scanner
		...
		System.out.println("Enter the name of the .bib file:");
			...
			//assign the names of the files by user input
			input = kb.next(); 
		
			System.out.println("Enter the file name of the IEEE format .json file: ");
			IEEE = kb.next();
			
			System.out.println("Enter the file name of the ACM format .json file: ");
			ACM = kb.next();
			
			System.out.println("Enter the file name of the NJ format .json file: ");
			NJ = kb.next();
			...
			try{//try to read and write to IEEE
				...
				System.out.println("Could not open input file " +input+ " for reading. Please check if file exists!");
				...
				System.out.println("Problem detected with input file: " + input);
